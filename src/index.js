...
const config = {
    ...
    pixelArt: false,
    zoom: 1.0,
    scene: [PreloaderScene, SteeringScene, MapGen2DemoScene, MapGen3DemoScene, StartingScene, LoaderTestScene, SampleScene, MainMenuScene, BulletsDemoScene, VfxDemoScene],
    physics: {
        default: 'arcade',
        arcade: {
            gravity: {
